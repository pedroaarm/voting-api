...
class TelaFactoryTest {
  ...
  void votoOpcoesEmbutePayloadCompletoEmCadaOpcao() {
    ...
    assertThat(sim.body())
        .containsEntry("associadoId", "a1")
        .containsEntry("cpf", "19839091069")
        .containsEntry("opcao", "SIM");
  }
  ...
  void acoesPautaApontaApenasParaEndpointsReais() {
    ...
    assertThat(tela.itens().get(0).url())
        .isEqualTo("http://exemplo.com/api/v1/telas/pautas/" + pautaId + "/sessao/nova");
    assertThat(tela.itens().get(1).url())
        .isEqualTo("http://exemplo.com/api/v1/telas/pautas/" + pautaId + "/voto");
    assertThat(tela.itens().get(2).url())
        .isEqualTo("http://exemplo.com/api/v1/telas/pautas/" + pautaId + "/resultado");
  }
  ...
  void listaPautasGeraUmItemPorPautaApontandoParaAcoesDaPauta() {
    ...
    assertThat(tela.itens().get(0).url())
        .isEqualTo("http://exemplo.com/api/v1/telas/pautas/" + pautaId);
