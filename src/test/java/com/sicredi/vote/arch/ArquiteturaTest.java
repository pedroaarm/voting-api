...
class ArquiteturaTest {
  ...
  @ArchTest
  static final ArchRule aplicacaoNaoDependeDeAdapters =
      noClasses()
          .that()
  ...
  @ArchTest
  static final ArchRule aplicacaoNaoDependeDeJpaOuWeb =
      noClasses()
          .that()
          .resideInAPackage("..application..")
          .should()
  ...
  @ArchTest
  static final ArchRule webNaoDependeDePersistence =
      noClasses()
          .that()
