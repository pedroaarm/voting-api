...
class ConsultarResultadoTest {
    ...
    void apuraAposFechamento() {
        ...
        votos.salvar(Voto.builder().id(UUID.randomUUID()).pautaId(pauta).associadoId("a").opcao(OpcaoVoto.SIM).criadoEm(agora).build());
        votos.salvar(Voto.builder().id(UUID.randomUUID()).pautaId(pauta).associadoId("b").opcao(OpcaoVoto.SIM).criadoEm(agora).build());
        votos.salvar(Voto.builder().id(UUID.randomUUID()).pautaId(pauta).associadoId("c").opcao(OpcaoVoto.NAO).criadoEm(agora).build());
