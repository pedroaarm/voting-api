...
public class VotoJpaEntity {
    ...
    @Column(name = "associado_id") private String associadoId;
    @Enumerated(EnumType.STRING) private OpcaoVoto opcao;
    @Column(name = "criado_em") private Instant criadoEm;

    protected VotoJpaEntity() {}
    public VotoJpaEntity(UUID id, UUID pautaId, String associadoId, OpcaoVoto opcao, Instant criadoEm) {
        this.id = id; this.pautaId = pautaId; this.associadoId = associadoId; this.opcao = opcao; this.criadoEm = criadoEm;
    }
