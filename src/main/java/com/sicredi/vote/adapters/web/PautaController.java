        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:validacao\",\"title\":\"Requisicao invalida\",\"status\":400,\"errors\":[\"titulo: nao pode ser vazio\"]}")))
  })
  @PostMapping
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:validacao\",\"title\":\"Requisicao invalida\",\"status\":400,\"errors\":[\"duracaoMinutos: deve ser positivo\"]}"))),
    @ApiResponse(
        responseCode = "404",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:pauta-nao-encontrada\",\"title\":\"Pauta nao encontrada\",\"status\":404}"))),
    @ApiResponse(
        responseCode = "409",
