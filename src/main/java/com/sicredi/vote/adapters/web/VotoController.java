        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:validacao\",\"title\":\"Requisicao invalida\",\"status\":400,\"errors\":[\"cpf: nao pode ser vazio\"]}"))),
    @ApiResponse(
        responseCode = "409",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:elegibilidade-indisponivel\",\"title\":\"Servico de elegibilidade indisponivel\",\"status\":503}")))
  })
  @PostMapping
