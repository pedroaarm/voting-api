...
public record PautaResponse(
    @Schema(description = "Identificador da pauta", example = "3fa85f64-5717-4562-b3fc-2c963f66afa6")
    UUID id,

    @Schema(description = "Titulo da pauta", example = "Reforma do estatuto social")
    String titulo,
