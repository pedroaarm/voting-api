        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"pautaId\":\"3fa85f64-5717-4562-b3fc-2c963f66afa6\",\"status\":\"APROVADA\",\"totalSim\":10,\"totalNao\":3,\"total\":13}"))),
    @ApiResponse(
        responseCode = "404",
        ...
        content =
            @Content(
                ...
                examples =
                    @ExampleObject(
                        value =
                            "{\"type\":\"urn:vote:sessao-em-andamento\",\"title\":\"Sessao em andamento\",\"status\":409}")))
  })
  @GetMapping
